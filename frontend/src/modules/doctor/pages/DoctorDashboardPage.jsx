...
import { LayoutDashboard, Users, Clock, CheckCircle2, AlertCircle, ArrowRight, ShieldCheck } from "lucide-react";
    ...
    <DoctorShell title="Clinical Portal Dashboard" subtitle="Overview of pending patient cases and AI case-taking reviews">
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {/* Card 1: Needs Check */}
          <div className="bg-white border border-amber-200 rounded-3xl p-5 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-amber-700">Needs Verification</p>
              <h3 className="text-3xl font-extrabold text-slate-900 mt-1">{needsCheckCount}</h3>
              <p className="text-xs text-slate-500 mt-1">Ready for doctor review</p>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-5 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Awaiting Review</p>
              <h3 className="text-3xl font-extrabold text-slate-900 mt-1">{pendingCount}</h3>
              <p className="text-xs text-slate-500 mt-1">In kiosk intake queue</p>
            </div>
          ...
          <div className="bg-white border border-success-200 rounded-3xl p-5 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-success-700">Approved Today</p>
              <h3 className="text-3xl font-extrabold text-slate-900 mt-1">{approvedCount}</h3>
              <p className="text-xs text-slate-500 mt-1">Cases signed off</p>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-success-100 text-success-700 flex items-center justify-center">
        ...
        {/* Doctor Trust Banner */}
        <div className="bg-primary-950 text-white rounded-3xl p-6 shadow-md border border-primary-800 flex flex-col sm:flex-row items-center justify-between gap-4">
